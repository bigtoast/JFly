...
public class UpcomingEventsQueryImpl extends EventQueryBase<UpcomingEventsQuery> implements UpcomingEventsQuery {

	private static final long serialVersionUID = 2756982930804646787L;

	public String getBaseUrl(){ 
		return baseRestUrl + "/events/onsale.json?";
	}
    ...
    @Override
    public PaginatedResponse<Event> execute( JFly jFly ) { return jFly.execute(this); }
