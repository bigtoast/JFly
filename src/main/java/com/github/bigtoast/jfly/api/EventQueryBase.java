...
abstract public class EventQueryBase<T extends EventQueryBase<T>> extends JFlyCommandBase {
    ...
    private boolean hasPageNum(){ return pageNum != -1; }
    private boolean hasMaxResults(){ return maxResults != -1; }
    ...
    @SuppressWarnings("unchecked")
	public T withMaxResults(int cnt){
		this.maxResults = cnt;
		return (T) this;
	}
	
    @SuppressWarnings("unchecked")
	public T withPageNum(int num){
		this.pageNum = num;
		return (T) this;
	}
